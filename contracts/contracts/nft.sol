...
contract NFT is ERC1155, AccessControl, ERC1155Burnable, IERC2981 {
    ...
    function mint(address account, uint256 modelId, uint256 subscriptionId, uint256 amount, uint256 duration, uint256 royaltyFee, address royaltyReceiver, bytes memory data) public onlyRole(MINTER_ROLE) {
