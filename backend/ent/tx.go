...
func (tx *Tx) init() {
	...
	tx.SubscriptionMetis = NewSubscriptionMetisClient(tx.config)
	tx.SubscriptionMoonbeam = NewSubscriptionMoonbeamClient(tx.config)
	tx.SubscriptionZkEVM = NewSubscriptionZkEVMClient(tx.config)
